...
# Before the loop starts, create a list to keep track of the names recognized in the last frame
...
while True:
    ...
    for (top, right, bottom, left), face_encoding in zip(face_locations, face_encodings):
        ...
        # If a recognized name is found (not "Unknown"), print it to the console
    ...
    # Check and print only the new recognized names
    for name in current_recognized_names:
        if name not in last_recognized_names:
            print(f"Recognized: {name}")

    # Update the list of last recognized names for the next frame
